 ...
 * @LastEditTime: 2022-12-09 14:32:19
...
namespace MoChengEngine::FrameWork::Core::Rendering
{
    ...
    public:
            ...
            [](Wrapper::SwapChain::Ptr swapchain)
        {
            ...
            auto resultFormat =
                FindSupportedFormat(swapchain->Get_device(), formats, VK_IMAGE_TILING_OPTIMAL,
                                    VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT);
            return Wrapper::Image::CreateR(
                swapchain->Get_device(), swapchain->Get_extent2D().width,
                swapchain->Get_extent2D().height, resultFormat,
          ...
          [[nodiscard]] VkAttachmentReference Get_Attachement_Reference(int index) override
        {
            ...
            finalAttachmentRef.layout = VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
